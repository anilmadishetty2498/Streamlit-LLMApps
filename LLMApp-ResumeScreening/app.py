    ...
    if submit:
        with st.spinner('Wait for it...'):
           ...
           # st.write(st.session_state['unique_id'])
            ...
            push_to_pinecone(pinecone_index_name,embeddings, final_docs_list)
            st.write('pushed to pinecone')

            #Fecth relavant documents from PINECONE
            relavant_docs = similar_docs(job_description,document_count,pinecone_index_name,embeddings,st.session_state['unique_id'])
